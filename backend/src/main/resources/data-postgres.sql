...
SELECT 'Create a Car Object',
    ...
    'Toyota is driving',
       2
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Create a Car Object');
...
SELECT 'Encapsulation - Person',
    ...
    'Person name: Alice',
       2
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Encapsulation - Person');
...
SELECT 'Inheritance - Animal and Dog',
    ...
    2
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Inheritance - Animal and Dog');
...
SELECT 'Polymorphism - Override info()',
    ...
    'I am a student',
       2
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Polymorphism - Override info()');
...
SELECT 'Putting it all together',
    ...
    'Balance: 500.0',
       2
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Putting it all together');
...
SELECT 'ArrayList of Languages',
    ...
    E'Java\nPython\nC++',
    3
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'ArrayList of Languages');
...
SELECT 'HashSet - No Duplicates',
    ...
    '2',
       3
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'HashSet - No Duplicates');
...
SELECT 'HashMap - Get Value',
    ...
    'Java',
       3
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'HashMap - Get Value');
...
SELECT 'Queue - FIFO Order',
    ...
    E'Java\nPython\nC++',
    3
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Queue - FIFO Order');
...
SELECT 'Generic Box',
    ...
    'Hello Generics',
       3
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Generic Box');
...
SELECT 'Filter with Stream',
    ...
    E'Alex\nAna',
    4
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Filter with Stream');
...
SELECT 'Lambda - Double Numbers',
    ...
    E'2\n4\n6\n8\n10',
    4
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Lambda - Double Numbers');
...
SELECT 'Stream - Count Elements',
    ...
    '2',
       4
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Stream - Count Elements');
...
SELECT 'Handle ArithmeticException',
    ...
    4
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Handle ArithmeticException');
...
SELECT 'Stream - Sum with Reduce',
    ...
    '15',
       4
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Stream - Sum with Reduce');
...
SELECT 'BufferedReader from String',
    ...
    E'Hello\nWorld',
    5
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'BufferedReader from String');
...
SELECT 'Try-With-Resources',
    ...
    'Java Files',
       5
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Try-With-Resources');
...
SELECT 'Count Lines',
    ...
    '3',
       5
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Count Lines');
...
SELECT 'Handle IOException',
    ...
    'Error: File not found',
       5
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Handle IOException');
...
SELECT 'Read and Process Lines',
    ...
    '60',
       5
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Read and Process Lines');
...
SELECT 'TCP vs UDP - Print Differences',
    ...
    6
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'TCP vs UDP - Print Differences');
...
SELECT 'InetAddress - Parse Address',
    ...
    '127.0.0.1',
       6
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'InetAddress - Parse Address');

DELETE FROM coding_exercise WHERE title = 'InetAddress - Get Localhost';
...
SELECT 'DatagramPacket - Message Length',
    ...
    '9',
       6
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'DatagramPacket - Message Length');
...
SELECT 'URL - Parse Components',
    ...
    E'https\nwww.example.com',
    6
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'URL - Parse Components');
...
SELECT 'Socket Exception Handling',
    ...
    'Connection failed',
       6
    WHERE NOT EXISTS (SELECT 1 FROM coding_exercise WHERE title = 'Socket Exception Handling');
